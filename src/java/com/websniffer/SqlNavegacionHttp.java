 ...
 * @author skuarch
 */
public class SqlNavegacionHttp {

    //==========================================================================
    /**
     * Constructor.
     */
    public SqlNavegacionHttp() {
    } //fin constructor
     ...
     */
    public String getSqlNavegacionHttp(String opcionGrafica, String fecha_inicial, String fecha_final, String limit1, String limit2) {
        ...
        try {
            ...
            if (opcionGrafica.equalsIgnoreCase("HTTP")) {
                sql = "SELECT (nav_url)campo1,(SUM(nav_ip_vol_tot) * 100) / (SELECT SUM(vol_min_tot)  FROM vol_min WHERE id_vol_min >= " + id1 + " AND id_vol_min <= " + id2 + ")campo2,  COUNT(*)campo3 FROM nav_url_min WHERE (id_nav_ip_min >=" + id1 + " AND id_nav_ip_min <= " + id2 + ")  GROUP BY campo1  ORDER BY campo2 DESC " + limit;
            }
