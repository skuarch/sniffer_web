<%@page import="ChartDirector.*,com.websniffer.ConnectPool,com.websniffer.SqlNavegacionHttp,com.websniffer.sqlVolTotal,com.websniffer.ConnectCollector,com.websniffer.GraficaDatos,java.sql.ResultSet" %>
...
<%
            ...
            sql = new SqlNavegacionHttp().getSqlNavegacionHttp(opcionGrafica, fecha_inicial, fecha_final, "0", "24");
            ...
            c.setPlotArea(80, 58, 645, 210, 0xffffff, -1, -1, 0xcccccc, 0xcccccc);
            ...
            lineLayer.addDataSet(data1, 0xeecc00, "Unión").setDataSymbol(Chart.DiamondSymbol, 11);
            ...
            barLayer.setHTMLImageMap("", "", "title='{xLabel}  |  {value}%'" + nombreUnidadMedida);
            ...
            String showText = "onmouseover='muestraInfoGrafica(\"{value|0}% \" );' ";
            ...
            //String variables = "paginaGrafica=&dataSet={dataSetName}&tipoGrafica=" + tipoGrafica + "&opcionGrafica=" + opcionGrafica + "&tiempoGrafica=" + tiempoGrafica + "&fecha_inicial=" + fecha_inicial + "&fecha_final=" + fecha_final + "&unidadMedida=" + unidadMedida + "&nombreUnidadMedida=" + nombreUnidadMedida + "&label={xLabel} &ip_remoto=" + ip_remoto + " ',400,600)";

            // Create an image map for the chart
            String imageMap1 = c.getHTMLImageMap("javascript:openWindow('detalleNavegacionHttp.jsp?label={xLabel}", "',750,450,true,'')", showText + hideText + toolTip);
%>
<html>
    ...
    <body>
        ...
        <div align="center">
            ...
            <div class="buttons" align="right">
                ...
                <a href="javascript:openWindow('Scripts/xlsNavegacionChartHttp.jsp',400,270,true,'?');">
