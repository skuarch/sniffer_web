<%@page import="ChartDirector.*,com.websniffer.ConnectPool,com.websniffer.sqlVolTotal,com.websniffer.SqlPuertos,com.websniffer.ConnectCollector,com.websniffer.GraficaDatos,java.sql.ResultSet" %>
...
<%
            ...
            sql = new SqlPuertos().getSqlPuertos(opcionGrafica, fecha_inicial, fecha_final, "0", "24");
            ...
            if (tam > 0) {
                ...
                //data0 = new GraficaDatos(shortContext).getData(r, "campo2");
                //data1 = new GraficaDatos(shortContext).getData(r, "campo3");
                data2 = new GraficaDatos(shortContext).getData(r, "campo4");
            ...
            c.addTitle("PUERTOS " + opcionGrafica + " [ " + ip_remoto + " ] ", "Arial Bold", 14).setBackground(colorHeader, 0x000000, Chart.glassEffect());
            ...
            String showText = "onmouseover='ajaxMuestraPuerto(\"{xLabel}\" );' ";
            ...
            String imageMap1 = c.getHTMLImageMap("javascript:openWindow('level1Puerto.jsp?label={xLabel}", "',500,550,true,'&')", showText + hideText + toolTip);
%>
<html>
    ...
    <body>
        ...
        <div align="center">
            ...
            <div class="buttons" align="right">
                ...
                <a href="javascript:openWindow('Scripts/xlsPuertosChart.jsp',400,270,true,'?');">
        ...
        <div align="left" id="detalleInfo" style="margin-left: 10px">
