<%@page import="ChartDirector.*,com.websniffer.ConnectPool,com.websniffer.SqlIps,com.websniffer.sqlVolTotal,com.websniffer.ConnectCollector,com.websniffer.GraficaDatos,java.sql.ResultSet" %>
...
<%
            ...
            sql = new SqlIps().getSqlIps(opcionGrafica, fecha_inicial, fecha_final, "0", "24");

            r = new ConnectCollector(new com.websniffer.Context(request.getContextPath()).getShortContext()).select(sql, ip_remoto);

            tam = (int) new ConnectPool(new com.websniffer.Context(request.getContextPath()).getShortContext()).getNumFilas(r);
            ...
            if (tam > 0) {
                ...
                //data0 = new GraficaDatos(new com.websniffer.Context(request.getContextPath()).getShortContext()).getData(r, "campo2", 1L);
                //data1 = new GraficaDatos(new com.websniffer.Context(request.getContextPath()).getShortContext()).getData(r, "campo3", 1L);
                data2 = new GraficaDatos(new com.websniffer.Context(request.getContextPath()).getShortContext()).getData(r, "campo4", 1L);
                labels = new GraficaDatos(new com.websniffer.Context(request.getContextPath()).getShortContext()).getLabels(r, "campo1");
            ...
            int[] colors = {0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000};
            ...
            c.setPlotArea(85, 58, 680, 270, 0xffffff, -1, -1, 0xcccccc, 0xcccccc);

            c.addText(640, 40, "(c) Copyright SisPro", "arial.ttf");

            // Add a title to the chart using 8 pts Arial Bold font
            int colorHeader = Integer.parseInt(new com.websniffer.Theme(new com.websniffer.Context(request.getContextPath()).getShortContext()).getTitleChartColor().substring(2), 16);
            c.addTitle("IP's " + opcionGrafica, "Arial Bold", 14).setBackground(colorHeader, 0x000000, Chart.glassEffect());
            ...
            //layer.addDataSet(data0, 0xcccccc, "% Volmen entrada");
            // layer.addDataSet(data1, 0xaaffcc, "% Volumen salida");
            layer.addDataSet(data2, 0xb60000, "% Volumen total");
            ...
            String imageMap1 = c.getHTMLImageMap("javascript:openWindow('detalleIp.jsp?label={xLabel}", "',850,550,true,'&')", showText + hideText + toolTip);
%>
<html>
    ...
    <body>
        ...
        <div align="center">
            ...
            <div class="buttons" align="right">
                ...
                <a href="javascript:openWindow('Scripts/xlsIpsChart.jsp',400,270,true,'?');">
