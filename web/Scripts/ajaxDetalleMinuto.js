...
*/
function ajaxDetalleMinuto(minuto){
	...
	var r3 = Math.round(r1+r2,2);
        ...
        var ruta = "Scripts/detalleMinuto1.jsp?fecha_inicial="+window.opener.fecha_inicial+"&fecha_final="+window.opener.fecha_final+"&opcionGrafica="+window.opener.opcionGrafica+"&r3="+r3+"&clic="+window.opener.clic+"&tipoGrafica="+window.opener.tipoGrafica+"&tiempoGrafica="+window.opener.tiempoGrafica+"&unidadMedida="+window.opener.unidadMedida+"&nombreUnidadMedida="+window.opener.nombreUnidadMedida+"&minuto="+minuto+"&paginaGrafica="+window.opener.paginaGrafica+"&ip_remoto="+window.opener.ip_remoto+"&remoto="+window.opener.remoto;
