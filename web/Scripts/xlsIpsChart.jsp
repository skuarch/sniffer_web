<%@page import="ChartDirector.*,com.websniffer.ConnectPool,com.websniffer.SqlIps,com.websniffer.ConnectCollector,com.websniffer.GraficaDatos,java.sql.ResultSet" %>
...
<%
    ...
    sql = new SqlIps().getSqlIps(opcionGrafica, fecha_inicial, fecha_final, "0", "0");
