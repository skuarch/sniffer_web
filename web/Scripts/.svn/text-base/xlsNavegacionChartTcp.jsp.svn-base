<%@page import="ChartDirector.*,com.websniffer.ConnectPool,com.websniffer.SqlNavegacionTcp,com.websniffer.ConnectCollector,com.websniffer.GraficaDatos,java.sql.ResultSet" %>
...
<%    
    ...
    sql = new SqlNavegacionTcp().getSqlNavegacionTcp(opcionGrafica, fecha_inicial, fecha_final, "0", "0");
    ...
    <body>
        ...
        <table border="1">
            <thead>
                ...
                <tr>
                    <th bgcolor="#EAEAEA">SisPro Navegacion IP <%= opcionGrafica  %>  (<%= nombreUnidadMedida  %>) <% if(!ip_remoto.isEmpty()) out.println(ip_remoto); %></th>
                </tr>
