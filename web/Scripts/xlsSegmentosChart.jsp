<%@page import="ChartDirector.*,com.websniffer.ConnectPool,com.websniffer.SqlSegmentos,com.websniffer.ConnectCollector,com.websniffer.GraficaDatos,java.sql.ResultSet" %>
...
<%    
    ...
    sql = new SqlSegmentos().getSqlSegmentos(opcionGrafica, fecha_inicial, fecha_final, "0", "0");
    ...
    <body>
        ...
        <table border="1">
            <thead>
                ...
                <tr>
                    <th bgcolor="#EAEAEA">SisPro Segmentos <%= opcionGrafica  %>  (<%= nombreUnidadMedida  %>) <% if(!ip_remoto.isEmpty()) out.println(ip_remoto); %></th>
                </tr>
