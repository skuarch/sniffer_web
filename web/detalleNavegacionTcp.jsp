...
<html>
    <head>
        ...
        <script language="javascript" type="text/javascript" src="Scripts/ajaxDetalleNavegacionTcp.js"></script>
        <script language="javascript" type="text/javascript" src="Scripts/celdas.js"></script>

        <title>Detalle</title>

    </head>
    <body onload="ajaxDetalleNavegacionTcp('<%=request.getParameter("label") %>')">
        ...
        <center>
            ...
            <div id="header" align="center" style="background-color: <%= new com.websniffer.Theme(shortContext).getHeaderColor()%>; width: 690px; height: 15px; margin:0 auto 0 auto; border:1px solid <%= new com.websniffer.Theme(shortContext).getBorderColorHeader()%>;"></div>
                ...
                <!-- informacion -->
                <div>
                    [  <b>Detalle Navegación <%= request.getParameter("label") %></b> ] opción grafica [ <b><%= request.getParameter("opcionGrafica") %></b> ] [ <b><%= request.getParameter("nombreUnidadMedida") %></b> ]
                </div>
