<%@page import="ChartDirector.*,com.websniffer.ConnectPool,com.websniffer.SqlRendimiento,com.websniffer.ConnectCollector,com.websniffer.GraficaDatos,java.sql.ResultSet,com.websniffer.CriticLevel" %>
...
<%           
            ...
            if (tam > 0) {
                ...
                data0 = new GraficaDatos(shortContext).getData(r, "campo2", unidadMedidaLong);
                data1 = new GraficaDatos(shortContext).getData(r, "campo3", unidadMedidaLong);
                data2 = new GraficaDatos(shortContext).getData(r, "campo4", unidadMedidaLong);
                labels = new GraficaDatos(shortContext).getLabelsFechas(r, "campo1");
            ...
            c.addTitle("THROUGHPUT " + request.getParameter("opcionGrafica") + " [ " + ip_remoto + " ] ", "Arial Bold", 14).setBackground(colorHeader, 0x000000, Chart.glassEffect());
            

            // Add a title to the y axis
            c.yAxis().setTitle(request.getParameter("nombreUnidadMedida2") + " / seg");
            ...
            Mark mark = c.yAxis().addMark(new CriticLevel(ip_remoto,shortContext).getLevelRendimiento() / unidadMedidaLong, -1, "Nivel Critico");
            mark.setLineWidth(2);
            ...
            // Add a horizontal mark line to the chart at y = 40
            //double marca = intUmb / unidadMedidaLong;            
            Mark mark2 = c.yAxis().addMark(new CriticLevel(ip_remoto,shortContext).getMaxDown() / unidadMedidaLong, -1, "tasa transferencia" );
            mark2.setLineWidth(3);

            // Set the mark line to purple (880088) dash line. Use white (ffffff) for the mark
            // label.
            mark2.setMarkColor(c.dashLineColor(0xffff00), 0x000000);

            // Put the mark label at the left side of the mark, with a purple (880088)
            // background.
            mark2.setAlignment(7);
            mark2.setBackground(0x880088);
            mark2.setBackground(Chart.Transparent);
            ...
            layer.addDataSet(data0, 0xff0000, "Throughput de salida");
            layer.addDataSet(data1, 0x008800, "Throughput de entrada");
            layer.addDataSet(data2, 0x3333ff, "Throughput total");
            ...
            String variables = "minuto={xLabel}&dataSet={dataSetName}&tipoGrafica=" + tipoGrafica + "&opcionGrafica=" + opcionGrafica + "&tiempoGrafica=" + tiempoGrafica + "&fecha_inicial=" + fecha_inicial + "&fecha_final=" + fecha_final + "&unidadMedida=" + unidadMedida + "&nombreUnidadMedida=" + nombreUnidadMedida + "',400,600)";
        ...
        <div align="center">
            ...
            <div class="buttons" align="right">
                ...
                <%
                 ...
                 <a href="javascript:openWindow('levelRendimiento.jsp',400,470,true,'?');">
                ...
                <a href="javascript:openWindow('Scripts/xlsRendimientoChart.jsp',400,270,true,'?');">
